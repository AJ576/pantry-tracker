...
export default function Home() {
  ...
  return (
    <Box width = "100w"
      ...
      gap = {2}
    >
      <Box bgcolor={"#3ee4"} border = "2px solid #000"  p = {4} display = "flex" flexDirection={"column"}>
        <Typography variant="h1" type = "bold">PANTRY TRACKER</Typography>
      </Box>
      
      <Modal open = {open} onClose = {handleClose}>
        <Box position="absolute" top={"50%"} left="50%"  width={400}
          bgcolor={"white"} border = "2px solid #000" boxShadow={24} p = {4} display = "flex" flexDirection={"column"}
      ...
      <Box border="1px solid #333" boxShadow={24}>
        <Box width={"800px"}
          height="100px" bgcolor="#ADD8E6" alignItems={"center"}  justifyContent={"center"} display={"flex"}>
